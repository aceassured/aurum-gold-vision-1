        ...
        <div className="grid md:grid-cols-2 gap-16 items-stretch">
          ...
          >
            ...
            <div className="text-muted-foreground font-sans text-sm leading-relaxed space-y-1 mb-8">
              <p>Address: Jl. Tjilik Riwut Km 1 No. 1 Palangkaraya, Central Kalimantan 73112 Indonesia</p>
            </div>
            <p className="text-muted-foreground font-sans text-sm mb-2">
              Email: <a href="mailto:info@aurumitalia.co.id" className="text-gold hover:text-gold/80 transition-colors">info@aurumitalianusantara</a>
            </p>
            <p className="text-muted-foreground font-sans text-sm mb-8">
              Phone: <a href="tel:+62 813 4833 9994" className="text-gold hover:text-gold/80 transition-colors">+62 812 3456 7890</a>
            </p>
            <p className="text-muted-foreground/60 font-sans text-xs leading-relaxed mb-4">For business and investment enquiries, please use the contact form or reach us directly via email. We welcome institutional and qualified investor dialogue.</p>
            <div className="block w-full flex-1 min-h-[180px] border border-gold/20 shadow-lg overflow-hidden relative mt-4 bg-muted/30">
              <iframe
                ...
                title="PT Aurum Italia Nusantara Location" className="absolute inset-0"
              />
          ...
          <motion.div
            ...
            className="flex flex-col"
          >
            <h2 className="font-serif text-foreground text-3xl md:text-4xl mb-8 leading-tight">Get in Touch</h2>
            <form onSubmit={handleSubmit} className="flex flex-col flex-1 space-y-6">
              ...
              <div className="mt-auto">
                <motion.button type="submit" whileHover={{ scale: 1.02, boxShadow: "0 4px 20px hsl(225 70% 15% / 0.4)" }} whileTap={{ scale: 0.98 }} className="bg-navy text-gold border border-navy hover:bg-navy/80 px-8 py-3 text-xs tracking-[0.2em] transition-all duration-300 w-full">
                  SUBMIT ENQUIRY
                </motion.button>
              </div>
            </form>
